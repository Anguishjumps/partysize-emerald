...
const u16 gTrainerPalette_Lusamine[] = INCBIN_U16("graphics/trainers/palettes/lusamine.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_LUSAMINE, gTrainerFrontPic_Lusamine, gTrainerPalette_Lusamine),
};
